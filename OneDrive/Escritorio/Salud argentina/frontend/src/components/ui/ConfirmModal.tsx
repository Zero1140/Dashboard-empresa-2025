  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div
        ...
        className="relative bg-surface-1 border border-border rounded-xl shadow-xl w-full max-w-sm p-6 space-y-4 animate-fadeIn"
      >
        <h2 id="confirm-modal-title" className="text-text font-semibold text-base">{title}</h2>
